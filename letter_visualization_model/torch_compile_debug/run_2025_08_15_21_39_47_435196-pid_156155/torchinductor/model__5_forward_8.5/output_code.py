...
# kernel path: /tmp/torchinductor_Adithya/qi/cqibxgfnrz7p27e7zdohsipo2n7yzspblrl4phh6gy4zxso4x6er.py
...
def triton_red_fused_mean_mul_0(in_ptr0, in_ptr1, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp0 = tl.load(in_ptr0 + (r0_1 + 4608*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp1 = tl.load(in_ptr1 + (r0_1 + 4608*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp2 = tmp0 * tmp1
...
# kernel path: /tmp/torchinductor_Adithya/33/c333nbnitjkbb4zz245uu75ytdi23v32ymdvjzh2wg33eimgkhus.py
# Topologically Sorted Source Nodes: [mul, mean], Original ATen: [aten.mul, aten.mean]
# Source node to ATen node mapping:
#   mean => mean
#   mul => mul
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_mean_mul_0.run(primals_1, primals_2, buf1, 2, 4608, stream=stream0)
        del primals_2
        buf2 = empty_strided_cuda((), (), torch.float32)
        buf3 = buf2; del buf2  # reuse
        # Topologically Sorted Source Nodes: [mul, mean], Original ATen: [aten.mul, aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_mean_mul_1.run(buf3, buf1, 1, 2, stream=stream0)
        del buf1
