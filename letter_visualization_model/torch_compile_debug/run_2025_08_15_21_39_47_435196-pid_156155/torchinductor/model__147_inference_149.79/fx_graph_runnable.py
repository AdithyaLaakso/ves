...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        sym_float = torch.sym_float(arg0_1);  arg0_1 = None
        add = sym_float + 3.3106595277786255;  sym_float = None
        scalar_tensor = torch.ops.aten.scalar_tensor.default(add, dtype = torch.float64, device = device(type='cpu'), pin_memory = False);  add = None
        return (scalar_tensor,)
        
def load_args(reader):
    reader.symint(0)  # arg0_1
