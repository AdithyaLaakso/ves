...
def load_args(reader):
    buf0 = reader.storage(None, 29252, device=device(type='cuda', index=0))
    reader.tensor(buf0, (7313,), is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 36864, device=device(type='cuda', index=0))
    reader.tensor(buf1, (9, 1, 32, 32), is_leaf=True)  # arg1_1
    buf2 = reader.storage(None, 9216, device=device(type='cuda', index=0), dtype_hint=torch.bool)
    reader.tensor(buf2, (9, 1, 32, 32), dtype=torch.bool, is_leaf=True)  # arg2_1
