...
# kernel path: /tmp/torchinductor_Adithya/kt/cktmo3wlmqw5le5avxwxarprnizxz4mhwfisfbss6mqrbtgomjbl.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.div, aten.mul]
# Source node to ATen node mapping:
# Graph fragment:
#   %div : [num_users=1] = call_function[target=torch.ops.aten.div.Scalar](args = (%expand, 9216), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_div_mul_0.run(tangents_1, primals_1, buf0, 9216, stream=stream0)
        del primals_1
        del tangents_1
    return (None, buf0, )
