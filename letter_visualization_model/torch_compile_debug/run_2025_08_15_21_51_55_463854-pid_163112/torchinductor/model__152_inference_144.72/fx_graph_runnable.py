...
os.environ['_TORCHINDUCTOR_PYOBJECT_TENSOR_DATA_PTR'] = '139659364709680'
...
class Repro(torch.nn.Module):
    ...
    def forward(self):
        full_default = torch.ops.aten.full.default([], 105.37119925022125, dtype = torch.float64, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
        return (full_default,)
