...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2):
        mul = torch.ops.aten.mul.Tensor(primals_1, primals_2);  primals_2 = None
        mean = torch.ops.aten.mean.default(mul);  mul = None
...
def load_args(reader):
    ...
    reader.tensor(buf1, (20, 1, 32, 32), is_leaf=True)  # primals_2
