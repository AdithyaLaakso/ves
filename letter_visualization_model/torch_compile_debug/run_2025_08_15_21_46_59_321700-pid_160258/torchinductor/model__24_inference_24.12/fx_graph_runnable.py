...
os.environ['_TORCHINDUCTOR_PYOBJECT_TENSOR_DATA_PTR'] = '140109822473520'
...
class Repro(torch.nn.Module):
    ...
    def forward(self):
        full_default = torch.ops.aten.full.default([], 16.781541854143143, dtype = torch.float64, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
        return (full_default,)
