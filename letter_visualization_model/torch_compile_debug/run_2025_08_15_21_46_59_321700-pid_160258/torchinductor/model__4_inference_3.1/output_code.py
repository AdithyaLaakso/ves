...
# kernel path: /tmp/torchinductor_Adithya/mz/cmzyqixoy6vgovxb3w2nsvjvxsvvgx3tt7xcmnvs2aj2n4agalug.py
...
def call(args):
    ...
    args.clear()
    assert_size_stride(arg0_1, (15754, ), (1, ))
    assert_size_stride(arg1_1, (20, 1, 32, 32), (1024, 1024, 32, 1))
    assert_size_stride(arg2_1, (20, 1, 32, 32), (1024, 1024, 32, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((15754, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [neg], Original ATen: [aten.neg]
        stream0 = get_raw_stream(0)
        triton_poi_fused_neg_0.run(arg0_1, buf0, 15754, stream=stream0)
        del arg0_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((15754, ), (1, ), device='cuda:0', dtype=torch.float32)
