...
int basic_tiff(const char* filename, int width, int height, size_t bytes_per_line, unsigned char* data) {
    ...
    TIFFSetField(tif, TIFFTAG_SAMPLESPERPIXEL, 3);          // RGB = 3 samples
